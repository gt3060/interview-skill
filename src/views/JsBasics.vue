                    ...
                    <div style="width: 75%">
                        <div class="catalogStyle fontStyle">
                            ...
                            <div id="c2">
                                ...
                                <div class="fontIndent">
                                    <p>采用typeof方式</p>
                                    <el-button v-for="(item, index) in typeofData"
                                               :key="index"
                      ...
                      item === undefined
                        ...
                        : item
                                    ...
                                    <el-card style="margin: 15px 0px 0px 30px"
                                             shadow="hover">
                                    ...
                                    <el-button v-for="item in instanceofData"
                                               :key="item.type"
                                               @click="btnInstanceof(item.name, item.type)"
                                               type="primary"
                                               size="small"
                                               style="margin-left: 30px">{{ item.name }}</el-button>
                                    <el-card style="margin: 15px 0px 0px 30px"
                                             shadow="hover">
                                        <p>
                                            语法：
                                    ...
                                    <el-button v-for="item in objPrototypeCallData"
                                               :key="item.type"
                    ...
                    sex: "male"
                            ...
                            <div id="c12">
                                ...
                                <div class="fontIndent">
                                    ...
                                    <p>①Set对象构造函数创建实例</p>
                                    <p>
                                        <code>const set1 = new Set(); const set2 = new
                                            Set(['a','b','c','d'])</code>
                                    </p>
                                    <p>②Set对象中增加元素</p>
                                    <p>
                                        <code>set1.add('a');//向Set对象set1中增加值为'a',结果:Set
                                            {"a"}</code>
                                    </p>
                                    <p>
                                        <code>set2.add('a').add('e');//向Set对象set2中增加值为e，值为a不会添加，因为已经存在,结果:Set
                                            {"a", "b", "c", "d", "e"}</code>
                                    </p>
                                    <p>③Set对象中删除元素</p>
                                    <p>
                                    ...
                                    <code>let arr = [11,2,3,4,2,3]; let set3 = [...new
                                        Set(arr)];</code>
                                    <p>
                                        <strong>
                            ...
                            <div id="c14">
                                ...
                                <div class="fontIndent">
                                    ...
                                    <p>
                                        ②纯js代码
                                        <el-button @click="handleShowTimetoDate"
                                                   type="text"
                                                   style="margin-left: 15px">代码显示/隐藏</el-button>
                                    </p>
                                    <el-card v-if="isShowTimeToDate === true"
                                             shadow="hover">
                                        <pre>
                    ...
                    console.log(key);//1, 2, 4
                            ...
                            <div id="c19">
                                ...
                                <div class="fontIndent">
                                    ...
                                    <p>①只传第一个参数data</p>
                                    <p class="code">
                                        <code>let data = {name:"gengtian", info:{age:18,
                                            sex:"male"}}</code>
                                    </p>
                                    <p class="code">
                                        <code>JSON.stringify(data);// {"name":"gengtian",
