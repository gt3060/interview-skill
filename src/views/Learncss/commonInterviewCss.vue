    ...
    <div class="fontStyle backTopTarget">
        ...
        <div>
            <div style="display:flex">
                ...
                <p>
                    <el-button type="text"
                               @click="toCenter">12.居中</el-button>
                </p>
            </div>
        </div>
        <div>
        ...
        <div>
            ...
            <el-button type="text"
                       @click="toPseudoElement">Click Me</el-button>
        </div>
        <div>
            <div style="display:flex">
                <div style="margin:4px 7px 0px 0px">
        ...
        <div>
            <div style="display:flex">
                ...
                <p>
                    19.用Css创建三角形
                    <el-button type="text"
                               @click="toCreateTriangle">Click Me</el-button>
                </p>
            </div>
        </div>
    </div>
