      ...
      <div class="learnCardContain">
        ...
        <div class="titleStyle">
          ...
          <div class="titleFontStyle">
            ...
            <p>此篇主要包含，html相关考点、计算机网络相关知识、浏览器相关内容</p>
          </div>
        </div>
          ...
          <div style="width:75%;">
            <div class="catalogStyle fontStyle">
              ...
              <div id="c4">
                ...
                <span class="fontIndent">
                  <ul>
                    <li>渐进增强：针对低版本浏览器构建页面，保证最基本的功能，然后再针对高级浏览器进行效果、交互等改进和追加功能以达到更好效果；</li>
                    <li>优雅降级：一开始就构建最完整功能，然后再针对低版本浏览器进行兼容。</li>
                  </ul>
                </span>
              </div>
              <div id="c5">
                ...
                <span class="fontIndent">
                  <ul>
                    ...
                    <li>cookie存储大小有限，只有4k，超过的数据忽略，但是localStorage和sessionStorage存储大小为5M</li>
                    <li>
