            ...
            <div class="catalogStyle fontStyle">
              ...
              <div id="c0" style="margin: 20px 0px">
                ...
                <div class="fontIndent">
                  <span
                    >&lt;!DOCTYPE&gt;声明于文档最前面的位置，处于html标签之前，用于告知浏览器使用哪种html规范</span
                  >
                </div>
              </div>
              <div id="c1">
                ...
                <span class="fontIndent">
                  <ul>
                    ...
                    <li>
                      ...
                      例如:
                      <code
                        >&lt;link href="common.css" rel="stylesheet" /&gt;</code
                      >这也是为什么建议css的加载建议用link而不是@import。
                    </li>
                  </ul>
                </span>
              </div>
              ...
              <div id="c12">
                ...
                <span style="margin-left: 35px">
                  <strong class="fontIndet"
                    >为什么“握手”是三次，“挥手”却要四次？</strong
                  >
                </span>
                <p class="fontIndent">
                ...
                <span style="margin-left: 35px">
                  <strong class="fontIndet"
                    >为什么客户端在TIME-WAIT阶段要等2MSL?</strong
                  >
                </span>
                <ul class="fontIndent">
