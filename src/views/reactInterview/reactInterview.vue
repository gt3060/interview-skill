      ...
      <div class="learnCardContain">
        ...
        <div class="titleStyle">
          <div class="titleIconStyle">
            <img src="@/components/picture/test.jpeg" class="imgStyle" />
          </div>
          ...
          <div style="width: 75%">
            <div class="catalogStyle fontStyle">
              ...
              <div id="c3" style="margin: 20px 0px">
                ...
                <div class="fontIndent">
                  <span
                    >在代码调用setState之后，react会将传入的参数与状态进行合并，然后重复啊所谓的调和阶段，经过调和过程
              ...
              <div id="c4" style="margin: 20px 0px">
                ...
                <div class="fontIndent">
                  <div>
                    <img src="@/assets/reactLifeCircle.png" width="90%" />
                  </div>
                  <p>①挂载卸载过程</p>
                  <ul>
                    <li>constructor</li>
  ...
  data() {
    return {
      catalogHtmlData: [
        ...
        { index: "c1", name: "2.什么情况使用shouldComponentUpdate", i: "1" },
